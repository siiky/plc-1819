...
\subsection{Doctype, Titl e Autor}

\begin{figure}[h!]
  	\centering
   	\begin{tabular}[b]{0.4\linewidth}
    	\includegraphics[width=\linewidth]{header.png}
     	\caption{\LS}
   	\end{subfigure}
  	\begin{subfigure}[b]{0.4\linewidth}
    	\includegraphics[width=\linewidth]{header_latex.png}
    	\caption{\LaTeX}
  	\end{tabular}
...
\begin{figure}[h!]
  \centering
  \begin{tabular}[b]{c}
    \includegraphics[width=0.2\linewidth]{lista_enum.png} \\
    \small (a)
  \end{tabular} \qquad
  \begin{tabular}[b]{c}
    \includegraphics[width=.2\linewidth]{lista_enum_latex.png} \\
    \small (b)
  \end{tabular}
...
\begin{figure}[h!]
  \centering
  \begin{tabular}[b]{c}
    \includegraphics[width=0.3\linewidth]{capitulo.png} \\
    \small (a)
  \end{tabular} \qquad
  \begin{tabular}[b]{c}
    \includegraphics[width=.4\linewidth]{capitulo_latex.png} \\
    \small (b)
  \end{tabular}
