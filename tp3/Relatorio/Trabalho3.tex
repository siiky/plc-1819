...
Neste capítulo iremos descrever a concepção/desenho do analisador sintático iniciando cada ação semântica com um pequeno resumo seguido do código referido.
